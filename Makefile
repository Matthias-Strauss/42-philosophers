...
#    Updated: 2024/09/16 22:38:21 by mstrauss         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC		=	cc
CFLAGS	=	-DDEBUG=false -Wall -Wextra -Werror -g -D MAX_THREADS=$(MAX_THRDS) -D_REENTRANT -pthread -Ofast -ffast-math -march=native -mtune=native -funroll-loops -fsanitize=thread,undefined
LDFLAGS =	-pthread
RM		=	rm -rf
